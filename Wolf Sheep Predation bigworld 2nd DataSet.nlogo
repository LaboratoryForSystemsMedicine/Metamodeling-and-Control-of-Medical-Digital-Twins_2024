...
to go
  ...
  if ticks >= 2000 [
    export-plot "populations" (word "d:/GSW/02/results" random 250000 ".csv")
    setup]
end
...
"grass / 4" 1.0 0 -10899396 true "" "if model-version = \"sheep-wolves-grass\" [ plot count grass ]"
