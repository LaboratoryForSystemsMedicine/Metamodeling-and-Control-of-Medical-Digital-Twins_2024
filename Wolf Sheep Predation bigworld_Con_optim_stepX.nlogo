...
to go
  ...
  if ticks >= 1000 [
    ask wolves [if random-float 10000 < Wolf_Con [ die ]   ] ; 1573  1811
    ask sheep  [ if random-float 10000 < Sheep_Con  [ die ]   ] ;  251  294
    ;ask patches [if pcolor = green [if random-float 1000 < 5 [ set pcolor brown]]]
   ]
  ...
  if model-version = "sheep-wolves-grass" [ ask patches [ grow-grass ] ]
   ...
   if ticks >= 5010 [
    export-plot "populations" (word "D:/GSW/Test_Control/results_" Sheep_Con "_" Wolf_Con ".csv")
    set Sheep_Con Sheep_Con + 1
    if Sheep_Con > 59 [
      set Sheep_Con 29
      set Wolf_Con Wolf_Con + 1]
   setup]
...
"grass" 1.0 0 -10899396 true "" "if model-version = \"sheep-wolves-grass\" [ plot count grass]"
"Total Control" 1.0 0 -7500403 true "" "plot ( count sheep * Sheep_Con / 10000 ) + ( count wolves * Wolf_Con / 10000 )"
...
355
Total Control
( count sheep * Sheep_Con / 10000 ) + ( count wolves * Wolf_Con / 10000 )
0
1
11
